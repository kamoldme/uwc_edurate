...
function editUser(user) {
  ...
  // Avatar uploads were removed in the UWC pilot. Profile pictures still
  // come from Google (payload.picture captured at OAuth signup) and remain
  // displayed throughout the app, but no UI lets anyone upload/replace one.
  openModal(`
