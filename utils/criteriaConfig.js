...
const CRITERIA_COUNT = CRITERIA_CONFIG.length;
const CRITERIA_COLS = CRITERIA_CONFIG.map(c => c.db_col);

module.exports = { CRITERIA_CONFIG, CRITERIA_COUNT, CRITERIA_COLS };
