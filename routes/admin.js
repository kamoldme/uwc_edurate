...
// Admin avatar upload/remove endpoints (POST/DELETE /api/admin/users/:id/avatar)
// were removed in the UWC pilot — profile pictures are sourced from Google
// OAuth only and can no longer be replaced through the platform.
